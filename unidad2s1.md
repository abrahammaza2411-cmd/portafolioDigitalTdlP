...
Añade una alternativa para decisiones binarias; si la condición es
falsa, se ejecuta un bloque de código diferente.
...
Es una alternativa más limpia cuando se compara una sola
variable contra muchos valores específicos y constantes.
...
Si bien el anidamiento no es un tipo de estructura en si, Permite evaluar múltiples condiciones en orden. El programa revisa cada condición una por una; en cuanto una de ellas resulta verdadera, ejecuta ese bloque y se sale de toda la estructura.
